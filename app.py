...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=19af6446-6171-4641-8aba-9dcff8e1b6ff.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud; PORT=30699; UID=smm34240; PASSWORD=X5xiTLGkastJEVmZ; SECURITY=SSL;SSLCertificate = DigiCertGlobalRootCA.crt", "", "")
